<x-layout>
    ...
    <h2 style="text-align: center;">Subject Table</h2>
    <table style="border-collapse: collapse; width: 80%; margin: 20px auto;">
        <thead>
            <tr>
                ...
                <th style="border: 1px solid #000; padding: 8px 12px; background-color: #f2f2f2;">Description</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($subjects as $subject)
                <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-700">{{ $subject->name }}</td>
                    <td class="px-6 py-4 font-medium text-gray-700">{{ $subject->description }}</td>
                </td>
                </tr>
            @endforeach
        </tbody>
